...
const tld = ".hype";
const CONTRACT_ADDRESS = "0x14a14Ec5B21522CC2caF58261e1Ca389Ea3A6FC0";
...
const App = () => {
  ...
  const renderNotConnectedContainer = () => (
    <div className="connect-wallet-container">
      <img
        src="https://media.giphy.com/media/UJJqmGzg0nBPa/giphy.gif"
        alt="Hype gif"
      />
    ...
    return (
      <div className="form-container">
        ...
        <input
          type="text"
          value={record}
          placeholder="Describe your excitement"
    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          <header>
            <div className="left">
              <p className="title">🚀 Hype Name Service</p>
              <p className="subtitle">The most hyped API on the blockchain!</p>
            </div>
